...
handler.all = async function (m) {
    ...
    //creador y otros
    global.creador = 'Wa.me/51906002517'
    global.ofcbot = `${conn.user.jid.split('@')[0]}`
    global.asistencia = 'https://wa.me/qr/PAOHAKCEHGUXN1'
    global.namechannel = '@ApoloBot'
    ...
    //Emojis determinado de APOLOBOT Bot
    global.emoji = '🍁'
    global.emoji2 = '⭐'
    global.emoji3 = '✨️'
    global.emoji4 = '😴'
    ...
    // global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "51906002517-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: `${packname}`, orderTitle: 'Bang', thumbnail: icons, sellerJid: '0@s.whatsapp.net'}}}
    ...
    global.icono = [
        'https://cdn.russellxz.click/37c5ea8a.png',
        'https://cdn.russellxz.click/37c5ea8a.png',
        'https://cdn.russellxz.click/37c5ea8a.png'
    ].getRandom()
